...
import com.xiaofei.blog.dao.CategoryDao;
...
import com.xiaofei.blog.service.CategoryService;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryDao, Category> implements CategoryService {
    ...
    public PageResult<CategoryDTO> listCategories() {
        return new PageResult<CategoryDTO>(categoryDao.listCategoryDTO(), categoryDao.selectCount(null));
    }
