...
import com.xiaofei.blog.dao.ArticleDao;
import com.xiaofei.blog.dao.CommentDao;
import com.xiaofei.blog.dao.TalkDao;
import com.xiaofei.blog.dao.UserInfoDao;
import com.xiaofei.blog.dto.*;
import com.xiaofei.blog.entity.Comment;
import com.xiaofei.blog.service.BlogInfoService;
import com.xiaofei.blog.service.CommentService;
import com.xiaofei.blog.service.RedisService;
import com.xiaofei.blog.util.HTMLUtils;
...
import static com.xiaofei.blog.constant.RedisPrefixConst.COMMENT_LIKE_COUNT;
import static com.xiaofei.blog.constant.RedisPrefixConst.COMMENT_USER_LIKE;
import static com.xiaofei.blog.enums.CommentTypeEnum.*;
...
public class CommentServiceImpl extends ServiceImpl<CommentDao, Comment> implements CommentService {
    ...
    public PageResult<CommentBackDTO> listCommentBackDTO(ConditionVO condition) {
        // 统计后台评论量
        Long count = commentDao.countCommentDTO(condition);
        if (count == 0) {
            return new PageResult<>();
        }
        // 查询后台评论集合
