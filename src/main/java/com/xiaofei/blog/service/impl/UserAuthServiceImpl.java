...
import com.xiaofei.blog.dao.UserInfoDao;
import com.xiaofei.blog.dao.UserRoleDao;
import com.xiaofei.blog.dto.*;
import com.xiaofei.blog.entity.UserAuth;
import com.xiaofei.blog.entity.UserInfo;
import com.xiaofei.blog.entity.UserRole;
import com.xiaofei.blog.enums.LoginTypeEnum;
import com.xiaofei.blog.enums.RoleEnum;
import com.xiaofei.blog.exception.BizException;
import com.xiaofei.blog.service.BlogInfoService;
import com.xiaofei.blog.service.RedisService;
import com.xiaofei.blog.service.UserAuthService;
import com.xiaofei.blog.strategy.context.SocialLoginStrategyContext;
import com.xiaofei.blog.util.PageUtils;
import com.xiaofei.blog.util.UserUtils;
import com.xiaofei.blog.vo.*;
...
import static com.xiaofei.blog.constant.CommonConst.*;
import static com.xiaofei.blog.constant.MQPrefixConst.EMAIL_EXCHANGE;
import static com.xiaofei.blog.constant.RedisPrefixConst.*;
import static com.xiaofei.blog.enums.UserAreaTypeEnum.getUserAreaType;
import static com.xiaofei.blog.util.CommonUtils.checkEmail;
import static com.xiaofei.blog.util.CommonUtils.getRandomCode;
...
public class UserAuthServiceImpl extends ServiceImpl<UserAuthDao, UserAuth> implements UserAuthService {
    ...
    public PageResult<UserBackDTO> listUserBackDTO(ConditionVO condition) {
        // 获取后台用户数量
        Long count = userAuthDao.countUser(condition);
        if (count == 0) {
